...
class Mortal():
    def __init__(self):
        ...
        self.chart_time = QtCharts.QChart()
        self.series_time = QtCharts.QLineSeries()
        self.series_time2 = QtCharts.QLineSeries()
        self.chartviewTime = QtCharts.QChartView()



        self.chart_space = QtCharts.QChart()
        self.series_space = QtCharts.QLineSeries()
        self.series_space2 = QtCharts.QLineSeries()
        ...
        lay_time.addWidget(self.chartviewTime)

        #self.chart_space.addSeries(self.series_time)
        ...
        lay_space.addWidget(self.chartviewSpace)
    ...
    def buttonStart(self):
        ...
        #     # Create Chart and set General Chart setting
        #
        #     self.chart_time.removeSeries(self.series_time)
        #     self.series_time.append(self.outputExperimentStatisticsFileNo, float(newTableTuple[1]))
        #
        #     self.chart_time.addSeries(self.series_time)
        #     self.chart_time.setAnimationOptions(QtCharts.QChart.SeriesAnimations)
        ...
        #     # Create Chart and set General Chart setting
        #
        #     self.chart_space.removeSeries(self.series_space)
        #     self.series_space.append(self.outputExperimentStatisticsFileNo, int(newTableTuple[2][9:-3]))
        #
        #     self.chart_space.addSeries(self.series_space)
        #     self.chart_space.setAnimationOptions(QtCharts.QChart.SeriesAnimations)
        #     self.chart_space.legend().hide()
        ...
        #     # X Axis Settings
        #     axisX = QtCharts.QValueAxis()
        #     self.chart_space.addAxis(axisX, QtCore.Qt.AlignBottom)
        #     self.series_space.attachAxis(axisX)
        #
        #     # Y Axis Settings
        #     axisY = QtCharts.QValueAxis()
        #     self.chart_space.addAxis(axisY, QtCore.Qt.AlignLeft)
        #     self.series_space.attachAxis(axisY)
        #
        #     self.chartviewSpace.setChart(self.chart_space)
        #
        #
    ...
    def acceptInputQueries(self):
        ...
        self.query3 = self.queryui.plainTextEdit_query3.toPlainText()
        self.query4 = self.queryui.plainTextEdit_query4.toPlainText()
...
# app.exec_()
    ...
    def step(self, observation, action, currentSchema, currentTableContent, previousQueryTime):
        ...
        while(self.randomTab == action or self.randomTab == self.removeArrayTable or self.randomTab not in currentTableIDs):                 #avoid self-join
            self.randomTab = self.secondRL.secondTable_choose_action(action, currentTableIDs)
        ...
        if (action < 50 and self.randomTab > 50) or (action > 50 and self.randomTab < 50):  # one is from action, another one is from RDF
